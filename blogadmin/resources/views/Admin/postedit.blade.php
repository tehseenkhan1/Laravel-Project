					...
					<div class="pd-20 card-box mb-30">
						...
						<form action="{{route('postupdate')}}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="post_description" required><?=$d->post_description; ?></textarea>
							...
							<div class="form-group">
								...
								/>
                                <img src="<?=url('uploads/apifileregistration/'.$d->post_image); ?>" style="width: 80px;" >
