...
@section('pageTitle', 'All Post List')
										...
										<td>
											<div class="dropdown">
												...
												>
                                                    ...
                                                    $status = $d->status;
                                                    if($status == 1){ ?>
                                                        <a class="dropdown-item" href="{{url('disapproved/'.$d->post_id)}}"
														><i class="dw dw-eye"></i> Approved</a
													>
                                                   <?php }else{ ?>
                                                    <a class="dropdown-item" href="{{url('approved/'.$d->post_id)}}"
														><i class="dw dw-eye"></i> Disapproved</a
													>
                                                   <?php } ?>
