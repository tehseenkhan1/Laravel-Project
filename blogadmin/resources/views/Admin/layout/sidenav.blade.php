<div class="left-side-bar">
			<div class="brand-logo">
				<a href="{{url('dashboard')}}">
					...
					<img
						src="{{url('Admin/vendors/images/deskapp-logo-white.svg')}}"
						alt=""
						class="light-logo"
					/>
				</a>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					...
					<?php 
						$userId = Auth::user()->userrole;
						if($userId != 3){ ?>
						<li class="dropdown">
							<a href="{{route('addpost')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">Add Post</span>
							</a>
							<!-- <ul class="submenu">
						...
						<li class="dropdown">
							<a href="{{route('postlist')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">Post List</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="{{route('mybloglikes')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">My Blog Likes</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="{{route('mycomments')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">My Comments</span>
							</a>
						</li>
						<?php } ?>
						<?php 
						...
						<li class="dropdown">
							<a href="{{route('allpostlist')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">All Post</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="{{route('alllike')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">All Likes</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="{{route('allcomments')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
								><span class="mtext">All Comments</span>
							</a>
						</li>
						...
						<li class="dropdown">
							<a href="{{route('allblogs')}}" class="dropdown-toggle">
								<span class="micon bi bi-house"></span
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="{{url('Admin/vendors/images/coming-soon.png')}}" alt="" width="25"
								/></span>
							</a>
						</li> -->
					</ul>
